...
HISTORY_VERSIONS = [
    ...
    {
        "tag": "v2.2.42",
        "title": "v2.2.42 - 在线电视内嵌版",
        "desc": "电视彩蛋升级: 视频在启动器内部区域直接播放(内置Edge内核, 不再跳浏览器); 支持在页面内登录各平台账号; 彩蛋触发后永久开启「📺 视频」页签; 修复「平台首页/登录」按钮打开错页面(误开搜索页)的bug",
        "url": GITHUB_URL + "/releases/download/v2.2.42/VoxelLauncher.exe",
    },
    {
        "tag": "v2.2.28",
        "title": "v2.2.28 - 音乐下载版",
